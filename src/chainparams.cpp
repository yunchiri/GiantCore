...
public:
	...
	nMasternodeColleteralLimxDev = 1000; //Params().MasternodeColleteralLimxDev()
        ...
        assert(hashGenesisBlock == uint256("0x00000c14f0986fd5d9e8bd5ac812caf4f32f74b2ef13837fc59d482c19bd62af"));
...
public:
  ...
  if(genesis.GetHash() != uint256("0x"))
        ...
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000abbed2e17e30337b1355fa9ad7129fd40e06990955ff363faa9e5f29e51"));
