...
BitcoinGUI::BitcoinGUI(const PlatformStyle *_platformStyle, const NetworkStyle *networkStyle, QWidget *parent) : QMainWindow(parent),
                                                                            clientModel(0),
                                                                            walletFrame(0),
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GIANT-Coin") + " - ";
#ifdef ENABLE_WALLET
